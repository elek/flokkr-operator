...
import (
	...
	flokkrv1alpha1 "github.com/flokkr/flokkr-operator/pkg/api/flokkr/v1alpha1"
	versioned "github.com/flokkr/flokkr-operator/pkg/clientset/versioned"
	internalinterfaces "github.com/flokkr/flokkr-operator/pkg/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/flokkr/flokkr-operator/pkg/listers/flokkr/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.FlokkrV1alpha1().Components(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.FlokkrV1alpha1().Components(namespace).Watch(options)
			},
		},
		&flokkrv1alpha1.Component{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *componentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&flokkrv1alpha1.Component{}, f.defaultInformer)
}
